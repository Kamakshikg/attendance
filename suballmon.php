...
<?php
//   subject All month
function suballmon($month,$class,$subject)
{
 include("conn.php");
 $mont="ALL Month";
...
$mname="select monthname,totallect,c.monno  from month as m , conductedlect as c where m.monno=c.monno and subid ='$subject'  order by monid";
...
$sqlsub="SELECT rollno,attend as atte,c.monno   FROM $tablename ,conductedlect as c ,month as m where $tablename.cdtlid =c.cdtlid and c.monno=m.monno and  c.subid='$subject'  order by rollno,monid  asc"; // 
